        ...
        ws.onmessage = (event) => {
            ...
            switch(data.kind){
                case 'message_created':
                    // recebe a key da query
                    // me permite substituir os dados de uma query feita anteriormente
                    // no state eu tenho os dados da minha lista anterior a criação de uma nova mensagem
